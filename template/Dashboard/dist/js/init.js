...
var setHeightWidth = function () {
	...
	var verticdelab = $(".vertical-tab");
	if( verticdelab.length > 0 ){ 
		for(var i = 0; i < verticdelab.length; i++){
			var $this =$(verticdelab[i]);
...
/***** Worksfleet function start *****/
var $wrapper = $(".wrapper");
var Worksfleet = function(){
